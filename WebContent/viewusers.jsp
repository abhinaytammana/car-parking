...
<th>ID</th><th>NAME</th><th>MOBILE</th><th>EMAIL</th><th>ADDRESS</th><th>STATE</th><th>COUNTRY</th><th style="width:70px";>IMAGE</th><th>Action</th></tr>
</thead>
...
%>
<tbody>
<tr><td><%=id%></td><td><%=uname%></td><td><%=mobileno%></td><td><%=uemail%></td><td><%=address%></td><td><%=state%></td><td><%=country%></td><td><img src="image.jsp?id=<%=id%>" width="100px" height="50px"></td><td><a href="accept.jsp?id=<%=id%>"><%=approve%></td></tr>

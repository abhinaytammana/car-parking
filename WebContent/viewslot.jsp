...
<th>ID</th><th>SLOTNUM</th><th>SLOTAREA</th><th>FROMDATE</th><th>TODATE</th><th>TIME</th><th>AMOUNT</th><th>AVAILABILITY</th></tr>
</thead>
...
%>
<tbody>
<tr><td><%=sid%></td><td><%=slotnumber%></td><td><%=slotarea%></td><td><%=fromdate%></td><td><%=todate%></td><td><%=time%></td><td><%=Amount%></td><td><%=availability %></td></tr>

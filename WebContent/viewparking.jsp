...
String 	id=null,bid=null,uid=null,uname=null,vtype=null,vmodel=null,bdate=null,fdate=null,todate=null,time=null,area=null,slot=null;
...
try
{
	...
	ResultSet rs=st.executeQuery("select * from bookingslots where uid='"+id+"' ");
...
<%}}catch(Exception e){
 ...
 %> --%>
<td><%=vtype%></td><td><%=vmodel%></td><td><%=bdate%></td><td><%=fdate%></td><td><%=todate%></td><td><%=time%></td><td><%=area %></td><td><%=slot %></td><td><img src="imager.jsp?id=<%=bid%>" width="100px" height="50px"></td> 
<td><img src="imaged.jsp?id=<%=bid%>" width="100px" height="50px"></td></tr>
